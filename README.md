...
<p align="center">
  <a href="https://oitarho.github.io/cicig/"><img src="https://img.shields.io/badge/сайт-cicig-24f28a" alt="Сайт cicig"></a>
...
| Ограничения клиента | P2P-фильтр и индивидуальный лимит скорости скачивания 0–1000 Мбит/с |
...
Лимит скорости применяется к скачиванию через выбранный VPN-ключ. P2P-фильтр блокирует типовые BitTorrent-порты и распознаваемые сигнатуры, но не заменяет DPI: полностью скрытый трафик на случайных портах может пройти.
